...
for i = 1:5
    eval(['prob_face_init_' num2str(i) '= zeros(length(bing_uniform_samples),1);']);
...
prob_face_init_net = [prob_face_init_1 prob_face_init_2 prob_face_init_3 prob_face_init_4 prob_face_init_5];
