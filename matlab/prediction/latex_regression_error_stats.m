function latex_regression_error_stats(error_stats)

clc; clear input;

input.data = [error_stats]

% Set column labels (use empty string for no label):
input.tableColLabels = {'Mean', 'Mode', 'Median','Std\_deviation', 'Max', 'Min'};
% Set row labels (use empty string for no label):
input.tableRowLabels = {'Face\_1, Z up','Face\_2, Z down','Face\_3, Y up','Face\_4, Y down','Face\_5, X up','Face\_6, X down'};
