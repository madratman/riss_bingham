...
if (sim_call_type==sim_childscriptcall_initialization) then
    ...
    init_pose=io.open("/home/ratnesh/projects/riss/windows_riss_code/bingham/matlab/simple_solids/data/vrep_exp_cube_0.35/2/init_pose.csv", "w");
    final_pose=io.open("/home/ratnesh/projects/riss/windows_riss_code/bingham/matlab/simple_solids/data/vrep_exp_cube_0.35/2/final_pose.csv", "w");
    init_pose_euler=io.open("/home/ratnesh/projects/riss/windows_riss_code/bingham/matlab/simple_solids/data/vrep_cube_0.35/2/init_pose_euler.csv", "w");
    final_pose_euler=io.open("/home/ratnesh/projects/riss/windows_riss_code/bingham/matlab/simple_solids/data/vrep_cube_0.35/2/final_pose_euler.csv", "w");
    ...
    if count < threshold then 
        ...
        if (count%100==0) then
			...
			if count ~= 0 then 
               ...
               final_pose:write(count/100,",", position[1], ",", position[2], ",", position[3], ",", quaternion[4], ","
           ...
           simSetObjectPosition(handle,-1,position);
            ...
            if count < threshold_final_pose then
                ...
                --init_pose_euler:write(position[1], ",", position[2], ",", position[3], ",", r2a*orientation[1], ","
                  --  , r2a*orientation[2], ",", r2a*orientation[3], "\n")
                -- init_pose_euler:write(position[1], ",", position[2], ",", position[3], ",", r2a*euler_test[1], ","
                --     , r2a*euler_test[2], ",", r2a*euler_test[3], "\n")
			end
