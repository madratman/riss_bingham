...
if (sim_call_type==sim_childscriptcall_initialization) then
    ...
    final_pose=io.open("/home/ratnesh/projects/riss/windows_riss_code/bingham/matlab/simple_solids/data/vrep_exp_cube_0.35/6_small_drop_init_bing_uniform_samples/face_1_final_predicted.csv", "w");
    ...
    csv={}
    for line in io.lines('/home/ratnesh/projects/riss/windows_riss_code/bingham/matlab/simple_solids/data/vrep_exp_cube_0.35/6_small_drop_init_bing_uniform_samples/face_1_init_predicted.csv') do
        table.insert(csv, {})
        local i=1
        for j=1,#line do
