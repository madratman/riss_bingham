...
% Return the "outliers"
function [face_1_final, face_2_final, face_3_final, face_4_final, face_5_final, face_6_final, face_1_init, face_2_init, face_3_init, face_4_init, face_5_init, face_6_init, total] = classify_quat_orientation(init_quat, final_quat, length)
...
for(i=1:size(final_quat, 1))
	...
	%final_quat = [x y -x y]
	if(final_quat(i,1)== -final_quat(i,3) && final_quat(i,2)==final_quat(i,4))
