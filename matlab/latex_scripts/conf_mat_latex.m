...
input.tableColLabels = {'Face\_1, Z up','Face\_2, Z down','Face\_3, Y up','Face\_4, Y down','Face\_5, X up','Face\_6, X down', 'Total'};
% Set row labels (use empty string for no label):
input.tableRowLabels = {'Face\_1, Z up','Face\_2, Z down','Face\_3, Y up','Face\_4, Y down','Face\_5, X up','Face\_6, X down', 'Total'};
